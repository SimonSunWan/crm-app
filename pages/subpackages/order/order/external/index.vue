...
const handleAdd = () => {
  ...
  uni.navigateTo({
    url: `/pages/subpackages/order/order/external/add?${queryString}`,
  });
};
...
const handleCardClick = (item) => {
  ...
  uni.navigateTo({
    url: `/pages/subpackages/order/order/external/detail?${queryString}`,
  });
};
...
const handleEdit = (item) => {
  ...
  uni.navigateTo({
    url: `/pages/subpackages/order/order/external/edit?${queryString}`,
  });
};
