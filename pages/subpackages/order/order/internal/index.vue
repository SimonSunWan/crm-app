...
const handleAdd = () => {
  ...
  uni.navigateTo({
    url: `/pages/subpackages/order/order/internal/add?${queryString}`,
  });
};
...
const handleCardClick = (item) => {
  ...
  uni.navigateTo({
    url: `/pages/subpackages/order/order/internal/detail?${queryString}`,
  });
};
...
const handleEdit = (item) => {
  ...
  uni.navigateTo({
    url: `/pages/subpackages/order/order/internal/edit?${queryString}`,
  });
};
