...
import SliderVerify from "@/components/main/slider-verify/index.vue";
...
const handleLogin = async () => {
  ...
  try {
    ...
    setTimeout(() => {
      uni.switchTab({
        url: "/pages/main/home/index/index",
      });
    }, 1000);
  } catch (error) {
...
const forgotPassword = () => {
  uni.navigateTo({
    url: "/pages/main/auth/forget-password/index",
  });
};

const goToRegister = () => {
  uni.navigateTo({
    url: "/pages/main/auth/register/index",
  });
};
</script>
