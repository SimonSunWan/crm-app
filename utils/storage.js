...
export const storage = {
  ...
  getRememberedAccount() {
    ...
    const flag = uni.getStorageSync(STORAGE_KEYS.REMEMBER_PASSWORD_FLAG) || false
  ...
  setRememberPasswordFlag(flag) {
    uni.setStorageSync(STORAGE_KEYS.REMEMBER_PASSWORD_FLAG, flag)
  }
}
